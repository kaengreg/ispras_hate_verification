...
def build_arg_parser():
    ...
    parser.add_argument('--train-data', type=str, default='train_chat.jsonl')
    parser.add_argument('--output-dir', type=str, default="RuadaptQwen3-4B-Instruct_stance_lora")
    parser.add_argument('--logging-dir', type=str, default="RuadaptQwen3-4B-Insturct_stance_lora/logs")
    ...
    parser.add_argument('--deepspeed', type=str, default=None, help='Path to DeepSpeed config json. If set, enables DeepSpeed via Trainer.')
    parser.add_argument('--gradient-checkpointing', action='store_true', default=True, help='Enable gradient checkpointing (saves memory, useful for long context).')
